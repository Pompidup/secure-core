...
const NONCE_IMAGE_SMALL: [u8; 12] = [0xB0, 0xB1, 0xB2, 0xB3, 0xB4, 0xB5, 0xB6, 0xB7, 0xB8, 0xB9, 0xBA, 0xBB];
const NONCE_IMAGE_MEDIUM: [u8; 12] = [0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7, 0xC8, 0xC9, 0xCA, 0xCB];
const NONCE_PDF_LARGE: [u8; 12] = [0xD0, 0xD1, 0xD2, 0xD3, 0xD4, 0xD5, 0xD6, 0xD7, 0xD8, 0xD9, 0xDA, 0xDB];
const NONCE_TEXT_SMALL: [u8; 12] = [0xE0, 0xE1, 0xE2, 0xE3, 0xE4, 0xE5, 0xE6, 0xE7, 0xE8, 0xE9, 0xEA, 0xEB];
...
fn make_plaintext(size: usize, seed: u8) -> Vec<u8> {
    (0..size).map(|i| seed.wrapping_add((i % 256) as u8)).collect()
}
